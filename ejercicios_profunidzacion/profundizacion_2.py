...
#<>
temperatura_1 = float(input('Ingrese una temperatura: '))
temperatura_2 = float(input('Ingrese otra temperatura: '))
temperatura_3 = float(input('Ingrese otra temperatura: '))
...
#Ahora buscamos la temperatura_min
...
#Por ultimo sacamos la temperatura promedio
